...
const SalaryStatus = () => {
  ...
  const columns = [
    ...
    {
      title: 'Weekly-off Pay Applicable',
      ellipsis: true,
  ...
  return (
    <>
      <Pageheading title="Salary Paid Status" />
      <ToastContainer
        position="top-right"
        autoClose={2000}
