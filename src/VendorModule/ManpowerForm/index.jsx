...
const ManpowerForm = () => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        form.setFieldsValue({
          ...
          [SUB_DEPARTMENT_1]: data?.subDepartmentId1,
          [SUB_DEPARTMENT_2]: data?.subDepartmentId2,
          [SUB_DEPARTMENT_3]: data?.subDepartmentId3,
  ...
  const onFinish = async (values) => {
    ...
    const payload = {
      ...
      subDepartmentId1: values.subDepartment1 || null,
      subDepartmentId2: values.subDepartment2 || null,
      subDepartmentId3: values.subDepartment3 || null,
