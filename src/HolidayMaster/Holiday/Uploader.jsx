...
export default function Uploader({ isVisible, setIsVisible, refreshData }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      const res = await axiosInstance.post('/api/HolidayMaster/upload', formData, {
        headers: { Accept: '*/*' },
      })

      // console.log('GroupWiseStoreCodeMapping res: ', res)
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
        <div style={{ flex: 1 }}>
          <a href="/HolidaysUploadExcel.xlsx" download>
