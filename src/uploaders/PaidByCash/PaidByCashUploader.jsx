...
export default function PaidByCashUploader({ isVisible, setIsVisible, refreshData }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      const res = await axiosInstance.post('/api/PaidInCash/PaidInCashUploader', formData, {
        headers: { Accept: '*/*' },
      })
  ...
  return (
      ...
      title={
        <div style={{ textAlign: 'center' }}>
          ...
          <Paragraph style={{ margin: 0, fontSize: 12 }}>
            Upload Excel Sheet at once using this feature. Month Fomat Example - 'Aug-25
          </Paragraph>
        </div>
      }
      visible={isVisible}
    ...
    >
      <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
        <div style={{ flex: 1 }}>
          <a href="/PaidByCashUploader.xlsx" download>
