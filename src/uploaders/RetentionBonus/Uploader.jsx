...
export default function RetentionUploader({ isVisible, setIsVisible, refreshData }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      formData.append('excelFile', fixedFile)

      const res = await axiosInstance.post('/api/Uploader/UploadRetention', formData, {
        headers: { Accept: '*/*' },
      })
  ...
  return (
    ...
    >
      <Row gutter={[24, 16]}>
        ...
        <Col xs={24} md={12}>
          <a
            href="/RetentionExcel.xlsx"
            download
            style={{ display: 'inline-block', width: '100%', marginBottom: '0.6rem' }}
          >
            <Button
