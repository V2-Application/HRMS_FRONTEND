...
export default function LeaveOpeningBalUploader({ isVisible, setIsVisible, refreshData }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      const res = await axiosInstance.post('/api/Uploader/UploadLeaveOpeningBalTable', formData, {
        headers: { Accept: '*/*' },
      })
  ...
  return (
    ...
    >
      <Row gutter={[24, 16]}>
        ...
        <Col xs={24} md={12}>
          <a
            href="/LeaveOpeningBalUploader.xlsx"
            download
