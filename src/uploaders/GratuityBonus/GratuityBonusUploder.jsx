...
export default function GratuityBonusUploader({ isVisible, setIsVisible, refreshData }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      const res = await axiosInstance.post(
        '/api/Uploader/UploadBonusAndGratutityOpening',
        formData,
        {
          headers: { Accept: '*/*' },
        },
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
        <div style={{ flex: 1 }}>
          <a href="/GratuityBonusUploader.xlsx" download>
          ...
          <Paragraph type="secondary" style={{ fontSize: 15, marginTop: 8 }}>
            * Download, fill out, then upload the sample Excel file. Month Format example 1. for
            june - 'Jun-25, 2. for august - 'Aug-25
          </Paragraph>
