...
export default function EmpStoreAssignmentUploader({ isVisible, setIsVisible }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      const res = await axiosInstance.post(
        '/api/EmployeeStoreVisibilityMapping/UploadExcelWithDept',
        formData,
        { headers: { Accept: '*/*' } },
      )
