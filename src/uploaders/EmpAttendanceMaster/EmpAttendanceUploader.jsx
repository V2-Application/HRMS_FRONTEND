...
export default function EmpAttendanceUploader({ isVisible, setIsVisible, refreshData }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      const res = await axiosInstance.post('/api/Uploader/UploadEmpAttendanceMaster', formData, {
        headers: { Accept: '*/*' },
      })
