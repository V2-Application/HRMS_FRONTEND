...
export default function LastMonthSalaryUploader({ isVisible, setIsVisible, refreshData }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      const res = await axiosInstance.post('/api/Payroll/process-salary-upload', formData, {
        headers: { Accept: '*/*' },
      })
  ...
  return (
    ...
    >
      <Row gutter={[24, 16]}>
        ...
        <Col xs={24} md={12}>
          <a
            href="/LasMonthSalaryUploader.xlsx"
            download
