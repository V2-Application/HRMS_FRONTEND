...
export default function ECodeSeatMappingUploader({ isVisible, setIsVisible, refreshData }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      const res = await axiosInstance.post('/api/BgtSeatAssignment/UploadExcel', formData, {
        headers: { Accept: '*/*' },
      })
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
        <div style={{ flex: 1 }}>
          <a href="/ECodeSeatUploader.xlsx" download>
