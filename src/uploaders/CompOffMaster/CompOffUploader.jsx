...
export default function CompOffUploader({ isVisible, setIsVisible, refreshData }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      const res = await axiosInstance.post('/api/Uploader/UploadCompOff', formData, {
        headers: { Accept: '*/*' },
      })
