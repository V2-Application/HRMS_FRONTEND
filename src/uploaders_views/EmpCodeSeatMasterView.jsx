...
const EmpCodeSeatMasterView = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      console.log('weekly off policy api res:', response)
  ...
  return (
    <>
      <Pageheading title="Emp Code Seat Master" />
      <ToastContainer
        position="top-right"
        autoClose={2000}
...
export default EmpCodeSeatMasterView
