...
import ExpLetterTemplate from './IncrementLetterTemplate'
import IncrementLetterTemplate from './IncrementLetterTemplate'
import {
  Button,
  Col,
  DatePicker,
...
const IncrementLetterModal = ({
  ...
  const [isIncTemplateModalOpen, setIsIncTemplateModalOpen] = useState(false)

  const handleModalOpen = (details = {}) => {
    setTemplateDetails(details)
    setIsIncTemplateModalOpen(true)
    // handleCancel()
  }

  const handleModalClose = () => {
    setTemplateDetails(null)
    setIsIncTemplateModalOpen(false)
  }
  ...
  return (
    <>
      {isIncTemplateModalOpen && (
        <IncrementLetterTemplate
          isModalOpen={isIncTemplateModalOpen}
      ...
      <Modal
        title="Increment Letter Details"
        open={isModalOpen}
      ...
      >
        ...
        <Form layout="vertical" onFinish={onFinish}>
          <Row gutter={12}>
            ...
            <Col span={12}>
              {/* only integer - TO BE DONE */}
              <Form.Item
                label="Increment Amount"
                name="incrementAmount"
                rules={[{ required: true, message: 'Increment amount is required' }]}
              >
...
export default IncrementLetterModal
