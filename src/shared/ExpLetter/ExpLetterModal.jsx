...
import ExpLetterTemplate from './ExpLetterTemplate'
import {
  Button,
  Col,
  DatePicker,
...
const ExpLetterModal = ({ isModalOpen, handleCancel, empDetails = {}, setIsExpModalOpen }) => {
  const [templateDetails, setTemplateDetails] = useState(null)
  const [isExpTemplateModalOpen, setIsExpTemplateModalOpen] = useState(false)

  const handleModalOpen = (details = {}) => {
    setTemplateDetails(details)
    setIsExpTemplateModalOpen(true)
    // handleCancel()
  }

  const handleModalClose = () => {
    setTemplateDetails(null)
    setIsExpTemplateModalOpen(false)
  }
  ...
  return (
    <>
      {isExpTemplateModalOpen && (
        <ExpLetterTemplate
          isModalOpen={isExpTemplateModalOpen}
      ...
      <Modal
        title="Experience Letter Details"
        open={isModalOpen}
      ...
      >
        ...
        >
          ...
          <Descriptions.Item label="Joining Date">{empDetails?.joiningDate}</Descriptions.Item>

          <Descriptions.Item label="Last Working Date">
            {empDetails?.lastWorkingDate}
          </Descriptions.Item>
        </Descriptions>
