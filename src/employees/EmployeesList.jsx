  ...
  const columns = useMemo(() => {
    return [
      ...
      },
      {
        ...
        dataIndex: 'subDepartment1Name',
        key: 'subDepartment1Name',
        width: 150,
        ellipsis: true,
        render: (text) => text || '-',
      },
      {
        ...
        dataIndex: 'subDepartment2Name',
        key: 'subDepartment2Name',
        width: 150,
        ellipsis: true,
        render: (text) => text || '-',
      },
      {
        ...
        dataIndex: 'subDepartment3Name',
        key: 'subDepartment3Name',
        width: 150,
        ellipsis: true,
        render: (text) => text || '-',
      },
