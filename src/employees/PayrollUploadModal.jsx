...
export default function PayrollUploadModal({ isVisible, setIsVisible, refreshData }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      const res = await axiosInstance.post('/api/Payroll/upload', formData, {
        headers: { Accept: '*/*' },
      })
      ...
      console.error('error uploading payload excel: ', err)
  ...
  return (
      ...
      title={
        <div style={{ textAlign: 'center' }}>
          ...
          <Paragraph style={{ margin: 0, fontSize: 12 }}>
            Upload the Employees Payroll Excel Sheet at once using this feature.
          </Paragraph>
        </div>
      }
      visible={isVisible}
    ...
    >
      <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
        <div style={{ flex: 1 }}>
          <a href="/PayrollSampleSheet.xlsx" download>
            <Button icon={<DownloadOutlined />} type="primary">
              Download Payroll Sample Sheet
            </Button>
          </a>
