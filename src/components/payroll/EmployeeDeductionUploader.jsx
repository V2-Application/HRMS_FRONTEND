...
export default function EmployeeDeductionUploader({ isVisible, setIsVisible, refreshData }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      const res = await axiosInstance.post('/api/EmployeeNew/upload_employeededuction', formData, {
        headers: { Accept: '*/*' },
      })
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
        <div style={{ flex: 1 }}>
          <a href="/EmployeeDeductionUploader.xlsx" download>
