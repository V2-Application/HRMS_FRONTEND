...
export default function ProcessSalaryRequestUploader({ isVisible, setIsVisible, refreshData }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      const res = await axiosInstance.post(
        '/api/EmpAttendanceViewSnapshot/process-given-to-bank-excel-upload',
        formData,
        {
          headers: { Accept: '*/*' },
        },
