...
export default function EmployeeSalaryAddOnsUploader({ isVisible, setIsVisible, refreshData }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      const res = await axiosInstance.post('/api/EmployeeNew/upload_salaryaddoons', formData, {
        headers: { Accept: '*/*' },
      })
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
        <div style={{ flex: 1 }}>
          <a href="/EmployeeSalaryAddOnsUploader.xlsx" download>
