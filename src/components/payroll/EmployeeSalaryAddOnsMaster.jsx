...
import EmployeeSalaryAddOnsUploader from './EmployeeSalaryAddOnsUploader'

const { Search } = Input

const EmployeeSalaryAddOnsMaster = () => {
...
export default EmployeeSalaryAddOnsMaster
